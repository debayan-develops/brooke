  ...
  .btn:disabled { opacity: .5; cursor: not-allowed; }
    ...
    <section class="is-hero-bar">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
            ...
            {{-- FIX: Go back to Short Story Edit page --}}
            <a href="{{ route('admin.editShortStories', $id) }}" class="button blue">Finish & Go Back</a>
        </div>
    </section>
            ...
            <div class="card-content">
                ...
                <form id="galleryImagesForm" method="POST" action="{{ route('admin.shortStoryImageUpload.store',['id' => $id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="uploader">
                        ...
                        @enderror
                        <input type="hidden" name="short_story_id" value="{{ $id }}">
